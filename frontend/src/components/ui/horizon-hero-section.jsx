    ...
    useEffect(() => {
        ...
        const createStarField = () => {
            ...
            for (let i = 0; i < 3; i++) {
                ...
                for (let j = 0; j < starCount; j++) {
                    ...
                    // Color variation - adapted to slate/gray palette
        ...
        const createNebula = () => {
            ...
            const material = new THREE.ShaderMaterial({
                uniforms: {
                    time: { value: 0 },
                    // Adapted to slate palette - subtle blue-gray tones
                    color1: { value: new THREE.Color(0x475569) }, // slate-600
                    color2: { value: new THREE.Color(0x64748b) }, // slate-500
                    opacity: { value: 0.2 }
                },
                vertexShader: `
          varying vec2 vUv;
        ...
        const createMountains = () => {
            ...
            // Adapted to slate/gray color palette
            const layers = [
        ...
        `,
          ...
          void main() {
            ...
            vec3 atmosphere = vec3(0.5, 0.5, 0.5) * intensity;
        ...
        <div ref={containerRef} className="hero-container cosmos-style">
            ...
            <div className="hero-content cosmos-content">
                ...
                <div ref={subtitleRef} className="hero-subtitle cosmos-subtitle">
                    ...
                    <p className="subtitle-line">
                        perfectly matched to your preferences
                    </p>
                    <div className="mt-8 pointer-events-auto">
                        <Link
                            to="/login"
                            className="inline-block px-8 py-4 bg-slate-800 text-white text-lg font-semibold rounded-md hover:bg-slate-700 transition-all shadow-lg hover:shadow-xl transform hover:scale-105"
                        >
                            Start Discovering
                        </Link>
                    </div>
            ...
            <div className="scroll-sections" style={{ paddingTop: '100vh' }}>
                {[...Array(2)].map((_, i) => {
                    ...
                    const subtitles = {
                        0: {
                            line1: 'AI-powered product recommendations,',
                            line2: 'perfectly matched to your preferences'
                        },
                        1: {
                            line1: 'Discover a universe of products,',
                            line2: 'tailored specifically for you'
                        },
                        2: {
                            line1: 'Experience the next generation,',
                            line2: 'of personalized shopping assistance'
                        }
                    };
